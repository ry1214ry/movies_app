...
export default function MovieDetailsPage() {
  ...
  if (!movie) {
    ...
    return (
      <div className="px-6 md:px-16 py-16 space-y-8">
        <div className="flex flex-col items-center justify-center h-[40vh] gap-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="text-zinc-400 text-sm font-bold flex items-center gap-1 hover:text-white transition"
            >
              Browse All Movies
            </button>
          </div>
        ...
        {suggestions.length > 0 && (
          <MovieSectionGrid title="You Might Like" movies={suggestions} />
        )}
      </div>
    );
  }
  ...
  const getTrailerEmbedUrl = () => {
    ...
    const match = url.match(/(?:youtu\.be\/|youtube\.com\/(?:embed\/|watch\?v=))([a-zA-Z0-9_-]+)/);
    if (match) {
      return `https://www.youtube.com/embed/${match[1]}?autoplay=1&mute=${trailerMuted ? 1 : 0}&rel=0`;
    }
    return url;
  };
  ...
  return (
    <div className="px-6 md:px-16 py-12 space-y-12">
      ...
      >
        <div className="flex flex-col md:flex-row gap-8 items-start md:items-end w-full relative z-10">
          ...
          <div className="flex gap-2 w-full md:w-auto">
            ...
            <button
              onClick={handleShare}
              className="flex-1 md:flex-none p-3.5 rounded-xl border bg-zinc-900 border-zinc-800 text-zinc-300 hover:text-white transition flex items-center justify-center"
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {activeTab === "trailer" && (
            <div className="space-y-4">
              <div className="aspect-video w-full rounded-2xl overflow-hidden bg-black border border-zinc-900 shadow-2xl relative">
                <iframe
                ...
                <button
                  ...
                  className="absolute bottom-4 right-4 p-2 bg-black/60 backdrop-blur rounded-full text-white hover:bg-black/80 transition z-10"
              ...
              {movie.trailer_url && (
                <button
                  ...
                  className="flex items-center gap-2 text-red-500 text-xs font-bold hover:text-red-400 transition"
                  aria-label="Open trailer in full screen"
                >
                  <Play size={14} fill="currentColor" /> View Fullscreen Trailer
                </button>
              )}
            </div>
          )}
      ...
      {relatedMovies.length > 0 && (
        <MovieSectionGrid title="More Like This" movies={relatedMovies} />
      )}
